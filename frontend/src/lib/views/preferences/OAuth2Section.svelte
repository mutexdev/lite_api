<script lang="ts">
  ...
  export let updateAppearancePreferences: (patch: Record<string, unknown>) => void
</script>
	            ...
	            <section>
	              ...
	              <label class="inline-toggle oauth2-browser-toggle">
	                <input
	                  ...
	                  on:change={(e) => updateAppearancePreferences({ oauth2UseSystemBrowser: e.currentTarget.checked } as Partial<types.Preferences>)}
	                />
