...
lite_api/
  ...
  internal/
    core/                  the App: 195 bound methods, the state lock
...
195 bound methods. It is the largest package and is *supposed* to be — package
...
- `qa/bindings.sh` — the 189-method surface must not change by accident.
