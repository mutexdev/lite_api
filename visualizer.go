...
// VisualizerSandbox is the iframe sandbox attribute the frontend must use.
//
...
// required value is VisualizerSandbox and is asserted by a test of its own.
func (a *App) VisualizerDocument(collectionID, itemID string) (string, error) {
	...
	return buildVisualizerDocument(*item.Response.Visualizer), nil
}
